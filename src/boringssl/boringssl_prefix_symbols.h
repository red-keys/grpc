...
#define SSL_CTX_use_sign_PrivateKey BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_use_sign_PrivateKey)
#define SSL_CTX_use_enc_PrivateKey BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_use_enc_PrivateKey)
...
#define SSL_CTX_use_sign_certificate BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_use_sign_certificate)
#define SSL_CTX_use_enc_certificate BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, SSL_CTX_use_enc_certificate)
...
#define NTLS_client_method BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, NTLS_client_method)
#define NTLS_method BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, NTLS_method)
#define NTLS_server_method BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, NTLS_server_method)
